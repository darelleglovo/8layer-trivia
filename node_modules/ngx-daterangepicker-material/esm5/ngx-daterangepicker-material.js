...
var DaterangepickerComponent = (function () {
    function DaterangepickerComponent(el, _ref, localeConfig) {
        this.el = el;
        this._ref = _ref;
...
var DaterangepickerDirective = (function () {
    function DaterangepickerDirective(viewContainerRef, _changeDetectorRef, _componentFactoryResolver, _el, _renderer, differs, localeConfig) {
...
var NgxDaterangepickerMd = (function () {
    function NgxDaterangepickerMd(parentModule) {
        if (parentModule) {
    ...
    NgxDaterangepickerMd.forRoot = function (config) {
        if (config === void 0) { config = DefaultLocaleConfig; }
        return {
