...
export declare class DaterangepickerDirective implements OnInit, OnChanges, DoCheck {
    ...
    constructor(viewContainerRef: ViewContainerRef, _changeDetectorRef: ChangeDetectorRef, _componentFactoryResolver: ComponentFactoryResolver, _el: ElementRef, _renderer: Renderer2, differs: KeyValueDiffers, localeConfig: LocaleConfig);
    ngOnInit(): void;
