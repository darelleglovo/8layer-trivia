import { Injectable, Component, ElementRef, ViewChild, EventEmitter, Output, Input, forwardRef, ViewEncapsulation, ChangeDetectorRef, Directive, ViewContainerRef, ComponentFactoryResolver, HostListener, KeyValueDiffers, Renderer2, NgModule, Optional, SkipSelf } from '@angular/core';
...
class DaterangepickerComponent {
     ...
     * @param {?} localeConfig
     */
    constructor(el, _ref, localeConfig) {
        this.el = el;
        this._ref = _ref;
        ...
        this.locale = Object.assign({}, this._locale);
     ...
     */
    set locale(value) {
        this._locale = Object.assign({}, this.localeConfig, value);
    }
    /**
     * @return {?}
     */
    ...
    clickDate(e, side, row, col) {
        ...
        if (this.endDate || date.isBefore(this.startDate, 'day')) {
            // picking start
            if (this.timePicker) {
                let /** @type {?} */ hour = parseInt(this.timepickerVariables['left'].selectedHour, 10);
                if (!this.timePicker24Hour) {
                    var /** @type {?} */ ampm = this.timepickerVariables['left'].ampmModel;
                    if (ampm === 'PM' && hour < 12)
                        hour += 12;
                    if (ampm === 'AM' && hour === 12)
                        hour = 0;
                }
                var /** @type {?} */ minute = parseInt(this.timepickerVariables['left'].selectedMinute, 10);
                var /** @type {?} */ second = this.timePickerSeconds ? parseInt(this.timepickerVariables['left'].selectedSecond, 10) : 0;
            ...
            // picking end
            if (this.timePicker) {
                var /** @type {?} */ hour = parseInt(this.timepickerVariables['right'].selectedHour, 10);
                if (!this.timePicker24Hour) {
                    var /** @type {?} */ ampm = this.timepickerVariables['right'].ampmModel;
                    if (ampm === 'PM' && hour < 12)
                        hour += 12;
                    if (ampm === 'AM' && hour === 12)
                        hour = 0;
                }
                var /** @type {?} */ minute = parseInt(this.timepickerVariables['right'].selectedMinute, 10);
                var /** @type {?} */ second = this.timePickerSeconds ? parseInt(this.timepickerVariables['right'].selectedSecond, 10) : 0;
                date = date.clone().hour(hour).minute(minute).second(second);
            }
...
class DaterangepickerDirective {
     ...
     * @param {?} localeConfig
     */
    constructor(viewContainerRef, _changeDetectorRef, _componentFactoryResolver, _el, _renderer, differs, localeConfig) {
     ...
     */
    set locale(value) {
        this._locale = Object.assign({}, value, this.localeConfig);
    }
    /**
     * @return {?}
     */
...
class NgxDaterangepickerMd {
     ...
     * @return {?}
     */
    static forRoot(config = DefaultLocaleConfig) {
        return {
            ngModule: NgxDaterangepickerMd,
            providers: [
                { provide: LocaleConfig, useValue: Object.assign({}, DefaultLocaleConfig, config) }
            ]
        };
    }
}
...
NgxDaterangepickerMd.ctorParameters = () => [
    { type: NgxDaterangepickerMd, decorators: [{ type: Optional }, { type: SkipSelf },] },
];
...
export { NgxDaterangepickerMd, DaterangepickerComponent, DaterangepickerDirective, DefaultLocaleConfig as ɵb, LocaleConfig as ɵa };
